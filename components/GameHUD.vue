  ...
  >
    ...
    <div class="flex flex-col items-center pt-2 min-w-0">
      <template v-if="settings.gameMode === 'TRAINING'">
        <span class="text-gray-500 dark:text-slate-500 font-bold text-[10px] tracking-widest uppercase">ROUND {{ currentMatchIndex + 1 }}</span>
        <span class="text-gray-700 dark:text-slate-300 font-mono text-sm">{{ gameState.timeRemaining.toFixed(0) }}</span>
